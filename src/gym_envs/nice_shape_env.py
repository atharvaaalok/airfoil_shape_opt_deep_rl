...
class NiceShapeEnv(gym.Env):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            nice: A NICE to be used as the starting state for the network.
        ...
        with torch.no_grad():
            self._param_template = parameters_to_vector(self.nice.parameters()).detach().clone()
    ...
    def reset(self, seed: int | None = None):
        ...
        # Reinitialize nice to the network parameters that represent starting airfoil
        vector_to_parameters(self._param_template, self.nice.parameters())
    ...
    def step(self, action: np.ndarray):
        ...
        # Set nice parameters to the new parameter state
        vector_to_parameters(new_params, self.nice.parameters())
